...
import './EditAdaptationPage.css';

// Импорт изображений
import iconCrestik from '../img/crestIcon.png';
import shevronUp from '../img/shevronUp.png';
import shevronDown from '../img/shevronDown.png';
...
export const EditAdaptationPage: React.FC = () => {
            ...
            {mentors.map((m, i) => (
              <div key={i} className="chip">
                ...
                <button className="chip-delete-btn" onClick={() => setMentors(mentors.filter((_, idx) => idx !== i))}>
                  <img src={iconCrestik} alt="Удалить" className="icon-img-small" />
                </button>
              </div>
            ))}
          </div>
            ...
            <div className="stage-header">
              ...
              <div className="stage-actions">
                <button className="action-icon-btn" onClick={() => moveItem(stages, setStages, index, 'up')}>
                  <img src={shevronUp} alt="Вверх" className="icon-img-action" />
                </button>
                <button className="action-icon-btn" onClick={() => moveItem(stages, setStages, index, 'down')}>
                  <img src={shevronDown} alt="Вниз" className="icon-img-action" />
                </button>
                <button className="action-icon-btn close" onClick={() => removeStage(stage.id)}>
                  <img src={iconCrestik} alt="Удалить" className="icon-img-action" />
                </button>
              </div>
            </div>
...
export default EditAdaptationPage;