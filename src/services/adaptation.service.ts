...
export const adaptationService = {
  ...
  /** ИСПРАВЛЕНО: Возвращаем res.data, чтобы получить routeId напрямую */
...
//       const response = await api.get('/onboarding/tests'); 
//       return response.data;
//   },

//   // Обновить статус теста (или другие поля)
//   updateTest: async (id: number, data: Partial<Test>) => {
